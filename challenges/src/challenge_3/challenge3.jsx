  ...
  return (
    <form onSubmit={fakeSubmit}>
      ...
      <input
        ...
        value={formData.firstName} // Controlada
      />
        ...
        <div className="privacy-container">
          <label>
            <input
              ...
              value="yes"
              onChange={handleChange}
              checked={formData.privacyResponse === "yes"} // Controlled by state
            />
            Yes!
          </label>
          ...
          <label>
            ...
            //   defaultChecked
              onChange={handleChange}
              checked={formData.privacyResponse === "no"} // Controlled by state
            />
            No.
          </label>
          ...
          <label>
            <input
              ...
              value="absolutely"
              onChange={handleChange}
              checked={formData.privacyResponse === "absolutely"} // Controlled by state
            />
            Absolutely!
          </label>
        </div>
